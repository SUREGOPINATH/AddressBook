...
public class Controller {
    public static HashMap<Addressbook,String> adressbookmap=new HashMap<>();
       ...
       scanner.nextLine();
           ...
           switch (input) {
               case 1 -> {
                   ...
                   Controller.helper(addressbook, addressbookname, personServices, addressbookservices);
               }
               case 2 -> addressbookservices.close();
           }
       }
   }
   ...
   public static void quit(){
       ...
       adressbookmap.put(addressbook,"closed");
       if(addressbook.getSaved().equals("yes")){
           System.out.println("program terminated");
           System.exit(0);
       }
       else {
   ...
   public static Addressbook helper(Addressbook addressbook,String addressbookname,PersonServices personServices
       ...
       switch (input) {
           ...
           case 4 -> {
               ...
               addressbook.setSaved("no");
               System.out.println("addressbook sorted successfully");
               helper(addressbook, addressbookname, personServices, addressbookservices);
           }
           case 5 -> {
           ...
           case 6 -> addressbookservices.close();
       }
       return addressbook;
   }
}
